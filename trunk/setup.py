...
setup(
        ...
        #      * change in concepts in pirs.core (i.e. that touch all subpackages)
        #
        # Y -- Minor version, backward-compatible with all previous versions of the same major version.
        #      New minor verions when:
        #      * new classes, methods, functions are added
        #      * for alpha stage, when names are changed.
        #
        # Ya -- alpha stage. Means that API (class, method, function names) can be change.
        #       For alpha versions, backward compatibility not assumed.
        #
        # R -- Bugs counter.
        #
        version = '2.18a.10',
